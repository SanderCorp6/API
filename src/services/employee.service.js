  ...
  static async update(id, dataToUpdate, userId) {
    ...
    if (dataToUpdate.position_id && dataToUpdate.position_id !== existingEmployee.position_id) {
      await EmployeeHistory.create({
        ...
        description: `Change of position from ${existingEmployee.position_id} to ${dataToUpdate.position_id}`,
        previous_value: existingEmployee.position_id,
        new_value: dataToUpdate.position_id,
        created_by: userId,
      });
    }
